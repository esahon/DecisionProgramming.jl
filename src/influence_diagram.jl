...
mutable struct InfluenceDiagram
    ...
    X::Dict{Name, Probabilities}
    Y::Dict{Name, Utilities}
    P::AbstractPathProbability
    U::AbstractPathUtility
    translation::Utility
    function InfluenceDiagram()
        new(Dict{String, AbstractNode}())
    end
    """
    function InfluenceDiagram()
        return new(Dict{String,AbstractNode}(), 
                   Vector{String}(), 
                   Dict{String, Vector{String}}(), 
                   Dict{String, Vector{String}}(), 
                   Dict{String,State}(),
                   Dict{String, ChanceNode}(), 
                   Dict{String, DecisionNode}(), 
                   Dict{String, ValueNode}(), 
                   Dict{String, Probabilities}(), 
                   Dict{String, Utilities}(),
